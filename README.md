...
Участник дискорд сервера может при использовании команд этого бота:
 - **дайкарту** : получить коллекционную карту 1 раз в 24 часа или просмотреть через сколько времени он ее сможет получить
 - **покажимне** :просмотреть список и количество карт одного типа, которые он уже получил
 - **профиль** : просмотреть статистику пользователя сервера по выпавшим картам 
 - **помощь** : получить справку о командах бота
 - **неисследовано** : узнать количество карт, которых не выпало ни одному из участников сервера на данный момент 
 - **выдайкарту** : выдать 1 карту указанному пользователю
 - **активируй** : активировать код для получения шанса получить катру еще раз
 - **создатькод** : создать код, который могут использовать пользователи для получения возможности получить карту
 - **удалитькарту** : удалить карту из системы и у всех пользователей
 - **новаякарта** : добавить в пул выпадения карт новую карту
 - **изменитькарту** : изменить существующую карту в системе и у всех пользователей
 - **обновикрутки** : дать возможность всем или конкретному пользователю получить карту
